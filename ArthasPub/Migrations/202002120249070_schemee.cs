namespace ArthasPub.Migrations
{
    ...
    public partial class schemee : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CartItem", "OrderId", "dbo.Order");
            DropForeignKey("dbo.Order", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.CartItem", "ItemId", "dbo.Item");
            ...
            DropIndex("dbo.CartItem", new[] { "ItemId" });
            DropIndex("dbo.CartItem", new[] { "OrderId" });
